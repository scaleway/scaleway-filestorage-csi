# Contribute to `scaleway-filestorage-csi`

`scaleway-filestorage-csi` is Apache 2.0 licensed and accepts contributions via GitHub.
This document will cover how to contribute to the project and report issues.

## Topics

- [Contribute to `scaleway-filestorage-csi`](#contribute-to-scaleway-filestorage-csi)
  - [Topics](#topics)
...
- The version of `scaleway-filestorage-csi` you are using (v0.1.0, master, ...)
...
- Does this align with the goals of `scaleway-filestorage-csi` ?
...
- Open a pull request against `scaleway-filestorage-csi` master branch that follows [PR guidelines](#pull-request-guidelines)

The maintainers of `scaleway-filestorage-csi` use a "Let's Get This Merged" (LGTM) message in the pull request to note that the commits are ready to merge.
