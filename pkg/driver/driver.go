...
const (
	// DriverName is the official name for the Scaleway File Storage CSI plugin.
	DriverName = "filestorage.csi.scaleway.com"

	// RegionTopologyKey is the topology key used to provision FileSystems.
	RegionTopologyKey = "topology." + DriverName + "/region"
