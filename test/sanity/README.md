...
against the `scaleway-filestorage-csi`.
...
> tests such as Instances and File Systems. There are no guarantees that
...
```console
$ go test -v -timeout 10m github.com/scaleway/scaleway-filestorage-csi/test/sanity
=== RUN   TestSanity
Running Suite: Sanity Suite - /home/user/dev/scaleway-filestorage-csi/test/sanity
===============================================================================
...
PASS
ok      github.com/scaleway/scaleway-filestorage-csi/test/sanity    146.104s
```
